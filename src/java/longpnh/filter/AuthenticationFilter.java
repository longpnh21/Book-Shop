...
public class AuthenticationFilter implements Filter {
    ...
    private String loginPage = "StartupServlet";
    private HttpServletRequest req;
    private static final boolean debug = true;

    private static final String[] loginRequiredURLs = {
        "/checkout", "welcome.jsp"
    };
    
    private static final String[] loginAdminRequiredURLs = {
        "/search", "/deleteAccount", "/updateAccount"
    };
    ...
    private boolean isAdminLoginRequired() {
        ...
        for (String loginAdminRequiredURL : loginAdminRequiredURLs) {
            if (requestURL.contains(loginAdminRequiredURL)) {
                return true;
            }
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if(session != null){
            RegistrationDTO dto = (RegistrationDTO) session.getAttribute("ACCOUNT");
            if(dto != null){    
                isLoggedIn = true;
        ...
        boolean isLoginRequest = uri.equals(loginURI);
        ...
        else if (!isAdmin && isAdminLoginRequired()){
            // the admin is not logged in, and the requested page requires
            //authorization, then forward to the login page
