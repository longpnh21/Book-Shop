...
public class FirstFilter implements Filter {
    ...
    private final String defaultPage = "StartupServlet";
    private static final boolean debug = true;
    
    private String[] exceptionalURLs = {
        ".html", ".jsp"
    };
    
    private boolean isExceptional(){
        String url = req.getRequestURL().toString();
        for(String exceptionalUrl : exceptionalURLs){
            if(url.contains(exceptionalUrl)){
                return true;
            }
        }
        return false;
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("FirstFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("FirstFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("FirstFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("FirstFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("FirstFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
